...
function App() {
  ...
  function projectname() { // project name
      ...
      const projectTitleByUrl = [
        { match: 'project://Nft', label: 'MUNIK XVI Website' },
        { match: 'project://Note', label: 'Invader Shop' },
        { match: 'project://AiAgent', label: 'TripleWhale Assistant' },
        { match: 'project://AgentConfig', label: 'AI Agents Config' },
        { match: 'project://BunBranch', label: 'Agents Config (bun branch)' },
        { match: 'project://PortfolioV2', label: 'Portfolio v2' },
        ...
        { match: 'project://D2CAutomation', label: 'D2C Marketing Automation Platform' },
        { match: 'project://Ittefaq', label: 'Ittefaq Social Platform' },
        { match: 'project://Rocklist', label: 'Rocklist Marketplace' },
        { match: 'project://ApiScrapper', label: 'API Scrapper Dashboard' },
        { match: 'project://Github', label: 'Khizar Ahmed GitHub' },
        { match: 'project://LinkedIn', label: 'Khizar Ahmed LinkedIn' },
        ...
        { match: 'khizarahmed.com', label: 'Portfolio v2' },
        { match: 'portfolio', label: 'Portfolio v2' },
        { match: 'linkedin.com/in/khizar-ahmed-0a62841b5', label: 'Khizar Ahmed LinkedIn' },
      ];

      const mapped = projectTitleByUrl.find((item) => projectUrl.includes(item.match));
      if (mapped) {
        return mapped.label;
      }
