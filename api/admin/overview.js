...
import { getMemoryAdminOverview } from '../_lib/chatMemory.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      console.error('admin/overview db fallback', dbError);
      return res.status(200).json(getMemoryAdminOverview());
    }
  } catch (error) {
